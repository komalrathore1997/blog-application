...
import com.blog.services.AttechmentService;
import com.blog.services.FileService;
import com.blog.services.PostService;
import com.blog.utils.BlogConstants;
...
public class PostController {
	...
	public ResponseEntity<PostResponse> getAllPost(
			...
			@RequestParam(value = "orderBy", defaultValue = BlogConstants.SORT_DIRECATION, required = false) String orderBy,
			@RequestParam(value = "sayt", required = false) String sayt) {

		PostResponse postResponse = this.postService.getAllPost(pageNumber, pageSize, sortBy, orderBy, sayt);
